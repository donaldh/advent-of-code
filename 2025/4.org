#+title: 2025 AoC Day 4 – Printing Department
#+date: 2025-12-04
#+tags[]: raku
...
Profiling the solution showed that computing the identity key for Complex so frequently is
costly. This revised solution caches all the adjacencies for each roll.

#+begin_src raku :results output :tangle "day4p2bis.raku" :shebang "#!/usr/bin/env raku"
use Test;
